...
Copyright (c) 2025-2026 Alberto Diaz Durana
...
Software components (src/, tests/, scripts/, configuration files) are
licensed separately under the MIT License. See LICENSE for details.
