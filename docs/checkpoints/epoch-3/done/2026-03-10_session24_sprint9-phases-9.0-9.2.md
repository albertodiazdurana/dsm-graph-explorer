...
- Committed: b891182
- Also created: DEC-007 (`docs/decisions/DEC-007-python-312-upgrade.md`)
- Also created: Epoch 3 plan (`docs/plans/epoch-3-plan.md`, 4-sprint roadmap)
...
- `docs/research/experiment-documentation-standards.md` created
...
- [ ] Blog journal entry (`docs/blog/epoch-3/`)
