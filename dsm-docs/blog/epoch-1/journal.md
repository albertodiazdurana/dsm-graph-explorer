...
- Project structure initialized (src/, tests/, dsm-docs/, outputs/)
...
- **Why in-repo dsm-docs/:** Following DSM 4.0 Section 2 pattern for software projects
...
- Documented parser library decision: `dsm-docs/decisions/DEC-001_parser_library_choice.md`
