...
2. **[wsl_migration_guide.md](dsm-docs/handoffs/wsl_migration_guide.md)** (v1.1)
...
3. **`dsm-docs/checkpoints/2026-02-04_wsl-migration-context_checkpoint.md`**
...
From [DEC-004_wsl_migration.md](dsm-docs/decisions/DEC-004_wsl_migration.md):
