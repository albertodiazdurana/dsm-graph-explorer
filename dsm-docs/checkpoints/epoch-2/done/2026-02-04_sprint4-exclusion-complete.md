...
### Documentation
- `dsm-docs/decisions/DEC-004_wsl_migration.md` — WSL migration decision record
- `dsm-docs/handoffs/wsl_migration_guide.md` — Generic migration guide for all repos
...
### CLI Usage
```bash
dsm-validate /path/to/repo --exclude "dsm-docs/checkpoints/*" --exclude "plan/**/*"
...
Patterns used:
- `dsm-docs/checkpoints/*` — checkpoint files
