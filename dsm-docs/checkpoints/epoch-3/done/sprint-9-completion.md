...
- Created: DEC-007 (`dsm-docs/decisions/DEC-007-python-312-upgrade.md`)
- Created: Epoch 3 plan (`dsm-docs/plans/epoch-3-plan.md`, 4-sprint roadmap)
...
- **Landscape research:** `dsm-docs/research/epoch-3-neo4j-landscape-research.md` (6 options evaluated)
- **Deep-dive:** `dsm-docs/research/epoch-3-falkordblite-deep-dive.md` (API, Cypher, persistence, testing)
