...
- **Blog materials:** Complete preparation in `dsm-docs/blog/materials.md`
...
Document your decision in `dsm-docs/decisions/DEC-001_parser_library_choice.md`.
...
At end of each work session, update `dsm-docs/blog/journal.md`:
...
Document answers in `dsm-docs/decisions/` as you make them.
...
- **DSM 4.0 Section 2:** Project Structure Patterns (in-repo dsm-docs/)
...
Create checkpoint in `dsm-docs/checkpoints/` when:
...
- [ ] Decisions documented in `dsm-docs/decisions/`
...
4. **Document as you go:**
   - Update `dsm-docs/blog/journal.md` after each session
   - Create decision documents in `dsm-docs/decisions/`
