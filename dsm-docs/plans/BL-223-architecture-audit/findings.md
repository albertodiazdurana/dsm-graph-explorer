...
| Node ID | File path (e.g., `dsm-docs/plans/epoch-1-plan.md`) |
...
| Node ID | `file_path:number` (e.g., `dsm-docs/DSM.md:2.3.7`) |
...
| Node ID | `file_path:h:slugified-title` (e.g., `dsm-docs/guides/overview.md:h:session-transcript-protocol`) |
